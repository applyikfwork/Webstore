...
import { LogIn, Mail, KeyRound, Loader2, ShieldOff } from "lucide-react";
    ...
    <div className="flex min-h-screen items-center justify-center bg-secondary/40 p-4">
      <Card className="w-full max-w-sm shadow-2xl">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription>
            {loginEnabled ? "Sign in to manage the App Showcase" : "Login is currently disabled"}
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-6">
            {!loginEnabled ? (
                <div className="flex flex-col items-center justify-center text-center p-4 rounded-md bg-muted/50">
